...
export interface paths {
    ...
    "/invites/accept": {
        ...
        get?: never;
        put?: never;
        /** Accept a player invite. */
        post: operations["AcceptPlayerInvite"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/events/{id}/rsvp": {
        ...
        put?: never;
        /** Set my event RSVP. */
        post: operations["SetMyEventRsvp"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        AcceptPlayerInviteRequest: {
            token: null | string;
            password: null | string;
        };
        AcceptPlayerInviteResponse: {
            /** Format: uuid */
            userId: string;
            email: string;
        };
        ...
        EventDetailsResponse: {
            ...
            /** Format: date-time */
            scheduledAtUtc: string;
            status: components["schemas"]["PokerEventStatus"];
            /** Format: date-time */
            createdAtUtc: string;
            /** Format: date-time */
            ...
            /** Format: int32 */
            notGoingCount: number | string;
            myRsvpStatus: null | components["schemas"]["RsvpStatus"];
            rsvps: components["schemas"]["EventRsvpResponse"][];
        };
        EventResponse: {
            /** Format: uuid */
            id: string;
        ...
        /** @enum {unknown} */
        PokerEventStatus: "Scheduled" | "Cancelled";
        ...
        /** @enum {unknown} */
        RsvpStatus: "Going" | "Maybe" | "NotGoing" | null;
...
export interface operations {
    ...
    AcceptPlayerInvite: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AcceptPlayerInviteRequest"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AcceptPlayerInviteResponse"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    SetMyEventRsvp: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["SetMyEventRsvpRequest"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["EventRsvpResponse"];
                };
            };
            /** @description Bad Request */
            400: {
